  ...
  return (
    <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
      ...
      <div className="p-3 sm:p-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="px-2 sm:px-4 py-1 sm:py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg text-xs sm:text-sm font-medium hover:from-indigo-700 hover:to-purple-700 transition-all"
          >
      ...
      <div className="relative aspect-video bg-gray-900">
        ...
        >
          {isPlaying ? (
            <Pause className="h-8 sm:h-12 w-8 sm:w-12 text-white" />
          ) : (
